...
from edu_api.utils.random_code import get_random_name
...
class UserModelSerializer(serializers.ModelSerializer):
    ...
    sms_code = serializers.CharField(min_length=4, max_length=6, write_only=True, help_text="短信验证码")
    ...
    def validate(self, attrs):
        ...
        if phone_code.decode() != sms_code:
            ...
            if num > 10:
                # 重新发送验证码
                raise serializers.ValidationError("错误次数太多请重新发送")
